...
from models import ConferenceForm, ConferenceForms, ConferenceQueryForm, ConferenceQueryForms
...
class ConferenceApi(remote.Service):
    ...
    @endpoints.method(message_types.VoidMessage, ConferenceForms, path='getConferencesCreated',
                      name='getConferencesCreated', http_method='POST')
    def getConferencesCreated(self, request):
        ...
        return ConferenceForms(items=[self._copyConferenceToForm((conf, displayName)
    ...
    def filterPlayground(self, request):
        ...
        conferences = conferences.filter(Conference.topics == 'Medical Innovations')
...
# - - - Registration - - - - - - - - - - - - - - - - - - - -
    ...
    @endpoints.method(message_types.VoidMessage, ConferenceForms, path='conferences/attending',
