...
The API is hosted on Google App Engine as application ID [conference-central-986](https://conference-central-986.appspot.com), and can be accessed via the [API explorer](https://apis-explorer.appspot.com/apis-explorer/?base=https://conference-central-986.appspot.com/_ah/api#p/).
